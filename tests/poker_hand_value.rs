//! Run this file with `cargo test --test poker_hand_value`.
...
impl Hand {
    fn value(&self) -> HandValue {
        ...
        match map.len() {
            ...
            4 => HandValue::OnePair,
            3 => if map.values().any(|val| *val == 3) { HandValue::ThreeOfAKind } else { HandValue::TwoPairs },
            2 => if map.values().any(|val| *val == 4) { HandValue::FourOfAKind } else { HandValue::FullHouse },
